        ...
        {step === 0 && (
          <motion.div key="step0" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <GlassCard className="!p-8 border-white/5 max-w-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                {categories.map((c) => (
                  <button
                    ...
                    className={`p-6 rounded-2xl border-2 transition-all text-left ${category === c.id
                        ? 'bg-[var(--accent)]/10 border-[var(--accent)]'
                        : 'bg-white/5 border-white/10 hover:border-white/20'
                      }`}
                  >
                    <span className="text-2xl mb-3 block">{c.icon}</span>
                    <span className={`text-[11px] font-black uppercase tracking-widest ${category === c.id ? 'text-[var(--accent)]' : 'text-white/40'}`}>
                      {c.name}
                    </span>
                  </button>
                ))}
              ...
              <button
                onClick={() => setStep(1)}
                className="w-full py-4 bg-[var(--accent)] text-black font-black uppercase text-xs rounded-2xl flex items-center justify-center gap-3 hover:shadow-[0_0_40px_rgba(0,245,255,0.3)] transition-all"
              >
        ...
        {step === 2 && (
          <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <GlassCard className="!p-8 border-white/5 max-w-xl">
              ...
              <div className="space-y-5">
                <div>
                  <label className="text-[9px] uppercase font-black tracking-[0.3em] text-white/30 mb-2 block">Focus: {category.toUpperCase()}</label>
                ...
                <div className="flex gap-3">
                  ...
                  <button onClick={() => setStep(3)} className="flex-1 py-4 bg-[var(--accent)] text-black font-black uppercase text-xs rounded-2xl flex items-center justify-center gap-3 hover:shadow-[0_0_40px_rgba(0,245,255,0.3)] transition-all">
              ...
              <div className="space-y-5">
                <div className="p-5 bg-white/[0.03] border border-white/5 rounded-2xl space-y-3">
                  <div className="flex justify-between text-[10px] uppercase font-black text-white/30">
                    <span>Title</span>
                    <span className="text-[var(--accent)]">{category.toUpperCase()} REFORM</span>
                  </div>
                ...
                <div className="p-5 bg-white/[0.03] border border-white/5 rounded-2xl space-y-3 max-h-40 overflow-y-auto custom-scrollbar">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex gap-3">
                    <button onClick={() => setStep(2)} className="px-6 py-4 bg-white/5 border border-white/10 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:border-white/20 transition-all">
                      <ChevronLeft size={14} /> Edit
                    </button>
                    <button onClick={handleDownload} className="flex-1 py-4 bg-white/10 text-white font-black uppercase text-xs rounded-2xl flex items-center justify-center gap-3 hover:bg-white/20 transition-all">
                      <FileText size={16} /> Download PDF (TXT)
                    </button>
                  </div>
