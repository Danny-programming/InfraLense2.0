    ...
    <div className="min-h-screen bg-[#020812] text-white p-8 font-sans selection:bg-[var(--accent)] selection:text-black">
      ...
      <header className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-2 items-center flex-wrap">
          ...
          <Link to="/admin/lifecycle" className="px-4 py-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 hover:bg-emerald-500 hover:text-black transition-all text-[9px] font-black uppercase tracking-widest flex items-center gap-2 text-emerald-400 hover:border-emerald-500">
